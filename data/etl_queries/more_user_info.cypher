...
MERGE (u:User {id: id})
ON MATCH SET u.location=location, u.followers_count=followers_count, u.friend_count = friends_count, u.favourites_count = favourites_count, u.screen_name = screen_name