...
CALL apoc.load.jsonParams(twitter.user_timeline_url + "tweet_mode=extended&count=200&user_id="+user.id,{Authorization:"Bearer "+twitter.bearer},null) yield value as status
